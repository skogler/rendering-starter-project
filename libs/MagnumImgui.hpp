...
public:
    ...
    void resizeEvent(const Magnum::Vector2i& winSize,
                     const Magnum::Vector2i& viewportSize);

    void drawFrame();

    bool mousePressEvent(
        const Magnum::Platform::Application::MouseEvent& event);

    bool mouseReleaseEvent(
        const Magnum::Platform::Application::MouseEvent& event);

    bool mouseScrollEvent(
        const Magnum::Platform::Application::MouseScrollEvent& event);

    bool mouseMoveEvent(
        const Magnum::Platform::Application::MouseMoveEvent& event);
    ...
    bool textInputEvent(
        const Magnum::Platform::Application::TextInputEvent& event);
...
private:
    ...
    bool keyPressReleaseEvent(
        const Magnum::Platform::Application::KeyEvent& event, bool value);
    bool mousePressReleaseEvent(
        const Magnum::Platform::Application::MouseEvent& event, bool value);
};
